...
export default function ChannelCategories() {
  ...
  return (
    <section className="relative z-10 bg-[#070A0F] py-16 text-white sm:py-24">
      <div className="mx-auto max-w-[1200px] px-5">
        
        {/* Heading above Red Box */}
        <div className="mx-auto mb-12 max-w-4xl text-center">
          <div className="inline-flex items-center justify-center gap-2 mb-4">
            <span className="h-px w-8 bg-gradient-to-r from-transparent to-[#00E5FF]"></span>
            <span className="text-[#00E5FF] text-sm font-bold tracking-[0.2em] uppercase">Premium Quality</span>
            <span className="h-px w-8 bg-gradient-to-l from-transparent to-[#00E5FF]"></span>
          </div>
          <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight leading-tight animate-fade-up">
            ...
            <span className="text-[#00E5FF]">Premium IPTV Service.</span>
          </h2>
        </div>
        ...
        >
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#00E5FF] mb-6 tracking-tight">
            IPTVMap subscription prices
          </h2>
          <p className="text-stone-300 text-sm md:text-base max-w-3xl mx-auto mb-8 font-medium">
            Buying iptv from <span className="font-bold text-white">IPTVMap</span> allows you to enjoy +50,000 Channels, +120,000 Films &amp; Series, and 200,000+ VODs.
          </p>
          <p className="text-2xl md:text-[28px] font-semibold text-white">
            High-Quality IPTV Servers <span className="text-[#00E5FF]">with 24/7 Uptime</span> and Zero Buffering!
          </p>
        </div>
        ...
        >
          {checks.map((text, i) => (
            <div key={i} className="flex items-center gap-4 bg-transparent border border-[#3b3552] rounded-full py-4 px-6 hover:border-[#00E5FF] transition-colors duration-300 group">
              <Check className="w-5 h-5 text-[#00E5FF] shrink-0" strokeWidth={3} />

...
export default function DeviceSupport() {
  return (
    <section className="py-20 bg-[#070A0F] text-white relative z-10 border-y border-white/10 overflow-hidden">
      <div className="max-w-[1320px] mx-auto px-6">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-14">
          <span className="text-xs font-bold uppercase tracking-widest text-[#00E5FF] mb-3 block">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight">
            ...
            <Link
              href="/installation"
              className="text-[#00E5FF] hover:text-[#00E5FF] transition-colors"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex items-center justify-center w-full">
            <div className="relative w-full max-w-[550px] p-3 bg-white/5 rounded-3xl border border-white/10 shadow-2xl backdrop-blur-md">
              <Image
                ...
                alt="IPTVMap Supported Streaming Devices"
                width={1024}
                height={350}
          ...
          <div className="space-y-8 w-full">
            ...
            <div className="flex gap-4 items-start group w-full">
              <div className="mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-emerald-500/20 text-emerald-400 group-hover:bg-[#00E5FF] group-hover:text-white transition-colors duration-300 border border-emerald-500/30">

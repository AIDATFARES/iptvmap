...
export const metadata: Metadata = {
  title: "IPTVMap – Best IPTV Subscription 2026 | 4K Live TV & Sports",
  description: "Stream 50,000+ live channels, 120,000+ movies & live sports in 4K with IPTVMap. Anti-freeze technology, instant activation & 99.9% uptime on all devices.",
  metadataBase: new URL("https://www.iptvmap.online"),
  alternates: {
    canonical: "/",
  },
  icons: {
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`dark scroll-smooth ${inter.variable} ${geist.variable}`}>
      ...
      <body suppressHydrationWarning className="bg-background text-on-background font-body-lg min-h-screen flex flex-col antialiased selection:bg-primary-container selection:text-on-primary-container">
        ...
        {/* Footer */}
        <footer className="w-full mt-auto border-t border-white/10 bg-[#070A0F]">
          <div className="grid max-w-[1400px] grid-cols-2 gap-x-4 gap-y-12 px-6 py-16 sm:grid-cols-4 sm:gap-x-8 sm:px-10 xl:grid-cols-[1.8fr_1fr_1fr_1fr_1fr] xl:gap-10 xl:px-12 mx-auto">
            ...
            <div className="col-span-1 min-w-0 space-y-6">
              <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-stone-300"><span className="border-b-2 border-[#00E5FF] pb-1.5">NAVIGATION</span></p>
            ...
            <div className="col-span-1 min-w-0 space-y-6">
              <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-stone-300"><span className="border-b-2 border-[#00E5FF] pb-1.5">SERVICE</span></p>
              <ul className="space-y-3 font-body-sm text-sm">
                ...
                <li><a className="text-stone-400 transition-colors hover:text-white" href="mailto:support@iptvmap.online">Email</a></li>
            ...
            <div className="col-span-1 min-w-0 space-y-6">
              <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-stone-300"><span className="border-b-2 border-[#00E5FF] pb-1.5">LEGAL</span></p>
            ...
            <div className="col-span-1 min-w-0 space-y-6">
              <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-stone-300"><span className="border-b-2 border-[#00E5FF] pb-1.5">PAYMENT</span></p>
